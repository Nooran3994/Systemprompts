      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            <a href="#home" className="text-[#343A40] hover:text-[#007BFF] transition-colors">
              Home
            </a>
          ...
          <div className="hidden lg:flex items-center flex-1 max-w-md mx-8">
            <div className="relative w-full">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 bg-[#F8F9FA] border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#007BFF] focus:border-transparent transition-all"
          ...
          {/* Subscribe Button */}
          <button 
            className="hidden md:block px-6 py-2 bg-[#007BFF] text-white rounded-lg hover:bg-[#0056b3] transition-colors shadow-md hover:shadow-lg transform hover:scale-105 transition-transform"
          ...
          {/* Mobile Menu Button */}
          <button className="md:hidden p-2 text-[#343A40]" aria-label="Menu">
        ...
        <div className="lg:hidden pb-4">
          <div className="relative w-full">
            ...
            <input
              ...
              value={searchQuery}
              onChange={(e) => onSearchChange(e.target.value)}
              className="w-full pl-10 pr-4 py-2 bg-[#F8F9FA] border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#007BFF] focus:border-transparent"
              aria-label="Search system prompts"
            />
          </div>
        </div>
