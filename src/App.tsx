...
function AppContent() {
  ...
  const handleDownload = (id: string) => {
    if (id === '1') {
      ...
      // Redirect to Gemini Gem for DevAlign Coach
      window.open('https://gemini.google.com/gem/15CoMyxSfxdf-knQzMoFGB8oDnn0wEc6S?usp=sharing', '_blank');
    } else if (id === '13') {
  ...
  const handleDownloadInstructions = (id: string) => {
    ...
    if (id === '7') {
      ...
      // DevAlign Coach - Free
      window.open('https://payhip.com/b/5Ou3K', '_blank');
    } else if (id === '13') {
